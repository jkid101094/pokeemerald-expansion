...
const u8 gText_MatchCallHiker_SAWYER_1_Strategy[] = _("I like it hot!");
const u8 gText_MatchCallHiker_SAWYER_1_Pokemon[] = _("Hot POKéMON!");
const u8 gText_MatchCallHiker_SAWYER_1_Intro1[] = _("As much as I love POKéMON,");
const u8 gText_MatchCallHiker_SAWYER_1_Intro2[] = _("I surely like hiking!");
...
const u8 *const gMatchCallFlavorTexts[REMATCH_TABLE_ENTRIES][CHECK_PAGE_ENTRY_COUNT] =
{
    ...
    [REMATCH_SAWYER_1] = MCFLAVOR(Hiker_SAWYER_1),

static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_USAGI_BAY - 1] = {MAP_GROUP(USAGI_BAY), MAP_NUM(USAGI_BAY), 34, 25},
    [HEAL_LOCATION_TENOU_TOWN - 1] = {MAP_GROUP(TENOU_TOWN), MAP_NUM(TENOU_TOWN), 15, 23},
    [HEAL_LOCATION_KINO_VILLAGE - 1] = {MAP_GROUP(KINO_VILLAGE), MAP_NUM(KINO_VILLAGE), 1, 16},
    [HEAL_LOCATION_SHINGO_CITY - 1] = {MAP_GROUP(SHINGO_CITY), MAP_NUM(SHINGO_CITY), 37, 25},
};

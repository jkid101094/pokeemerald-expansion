...
const struct Tileset gTileset_Sakura =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Sakura,
    .palettes = gTilesetPalettes_Sakura,
    .metatiles = gMetatiles_Sakura,
...
const struct Tileset gTileset_KinoGym =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_KinoGym,
    .palettes = gTilesetPalettes_KinoGym,
    .metatiles = gMetatiles_KinoGym,
    .metatileAttributes = gMetatileAttributes_KinoGym,
    .callback = NULL,
};
